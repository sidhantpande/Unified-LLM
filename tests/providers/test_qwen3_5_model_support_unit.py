...
def test_qwen3_5_variants_detect_qwen3_architecture() -> None:
    variants = [
        "Qwen/Qwen3.5-9B",
        "qwen/qwen3.5-9b",
...
def test_qwen3_5_family_capabilities_cover_dense_and_moe_variants() -> None:
    ...
    assert moe.get("architecture") == "qwen3"
    ...
    assert flagship_moe.get("architecture") == "qwen3"
    ...
    assert frontier_moe.get("architecture") == "qwen3"
...
def test_lfm2_family_capabilities_resolve_from_aliases() -> None:
    ...
    assert instruct.get("tool_support") == "native"
    assert instruct.get("structured_output") == "native"
    ...
    assert moe_24b.get("tool_support") == "native"
    ...
    assert moe_8b.get("tool_support") == "native"
    ...
    assert dense_26b.get("tool_support") == "native"
    ...
    assert dense_12b.get("tool_support") == "native"
